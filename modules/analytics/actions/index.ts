...
export const logProfileVist = async (userId: string, visitorIp?: string) => {
    ...
    // tring to find whether with this ip , he again visited or not within ohe hour if not then create a new entry
...
// action to get the how many time this specific usename's profile is visited
