...
interface BioBranchProfileProps {
...
const BioBranchProfile = ({ profileData }: BioBranchProfileProps) =>{
    const router = useRouter();   // for navigation
 
    const [isCopied, setIsCopied] = React.useState(false);    // state for managing copy url
    const [linkClicks, setLinkClicks] = React.useState<{ [key: string]: number }>({});    // tracking click count
    ...
    return (
        ...
        <div className="w-full max-w-md">
            ...
            >
                ...
                >
                <img src="/logo.png" alt="TreeBio" className="h-10 w-10 mr-2" />
                <span className="group-hover:scale-105 transition-transform duration-200 flex-1 text-center">
                    Join {profileData.username} on BioBranch
                </span>
...
export default BioBranchProfile;