"use client";
import {TreesIcon as Tree, BarChart3, Settings, QrCode, TrendingUp, Link2} from "lucide-react";
...
// Tools section : Not implementing yet only for ui, we will built later
const toolsItems = [
  {
